...
export default function CrmCustomerPriority() {
  ...
  const [filters, setFilters] = useState({ q: '', priority: '', stage: '', country: '', pending_costing: '', pending_freight: '' });
                ...
                <div key={row.id} className="border border-slate-100 rounded-lg p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-xs text-slate-500">
                    ...
                    <div>
                      ...
                      <div>核价 {row.pending_costing_count || 0} / 物流 {row.pending_freight_count || 0}</div>
                    </div>
                    <div>
