...
const RUNTIME_SURFACE_ROOTS = [
  ...
  'src/services/matrixLedgerCommand.js',
  'src/services/matrixLedgerCutover.js',
  'src/services/matrixLedgerStore.js',
  'src/services/matrixIntakeBridge.js',
  'src/services/matrixIntakeCandidate.js',
  'src/services/matrixRouteProfiles.js',
  'src/services/matrixSignalMatch.js',
  'src/services/matrixStreamOntology.js',
  'scripts/run-matrix-ledger-command.js',
...
const RUNTIME_MANIFEST = {
  ...
  '.runtime/vm_debug_ci/workspace/extensions/stream-card.cjs': '638052416b090007bd81c9033eb0d60acfde39f82a6dc28bdcb72671a32bfea4',
  ...
  '.runtime/vm_debug_ci/workspace/scripts/matrix-client.js': '0004d7bd67a66c9c5d6aa73153cdc0c764125560964ff724ff755e2e14e27bdf',
  ...
  '.runtime/vm_debug_ci/workspace/scripts/matrix-watch.js': '8b0e0eae24cd1005685c26bb816921b6c5ff0c743a1d688bce647c884e843b70',
  ...
  'src/db.js': 'a4aeb49b0b0d341a2677a5e906cfc2be9e66c5af008344704352e64d8af661c8',
  'src/server.js': '9d54afa69115ea0751900fcaf1df641a6a231c7dc40129d05692ad26bf8c088f',
  'src/lib/cacheIndexView.js': '4e6cd2b1e5b9c5dead0f41c7807b1779292d30291847135caf37ebf93e95699a',
  ...
  'src/lib/packetGate.js': 'd573ad57a792573e6174f954122a584ee656b6939f5322d8c57312c9cde3acc0',
  ...
  'src/services/matrixInboxScheduler.js': 'db735e688239800e3555b1c7dfb9e2167e396118ce6570767f500805fe3f9007',
  'src/services/matrixOverview.js': 'db51cdcd5e1f99760254e9da146e22149e6cc8eed337926564dc65fbd00ebc5c',
  'src/services/matrixThreadContext.js': '7552cdd96f980dc5030e280aa44af70c5a03820c24f84ce525555b77e970658d',
  ...
  'src/routes/matrix.js': '98d19877d19549ba20fde34f3741094de200a7c0b74ec5a27e2aa71af1080a88',
  ...
  'src/services/matrixStreamReview.js': 'ebf5ddd3a03d71290098cdb37180fcd233cfe434439417371213234cb7f0fe43',
  'src/services/matrixStreamText.js': 'e8bbef60949d2f05248a5def4effb175e5c693b3235aa7579a529591d4903b0a',
  'src/services/matrixStreamGate.js': '7b9c4138ea4bcf4af2bea1473b70cc3af972b9d56104e11ee54e08d354353785',
  'src/services/matrixStreamReadiness.js': 'cd96aa53541f2b4e75e07ebbd94795fe54a0eb88156864e87ed6811f2477d0ea',
  'src/services/matrixStreamFollowup.js': '6da2ca2b78cbcdd711ec097eed406e6a5ea60f7dc0a5a5f603e9eb4b0381cb74',
  'src/services/matrixStreamDelivery.js': '02f96bdc6656ca35f1d5d18e35986b6387d94caf7625dcf57f10e5a2f4d6d94e',
  'src/services/matrixRelayFactory.js': 'e1b009fc8c73ccaac3a9a1758a238d2df8e4d1373ad1b09e649020aff10d10e7',
  'src/services/matrixStreamPreview.js': '9929dbab902d78eb3084310fcc0222b1c1d7161843ab03ac6a8c8875d5c412bd',
  'src/services/matrixStreamCorrelation.js': '92763224278011cc48e45df0b41d439246e822166d6fff09ceb944936ca2e5b1',
  'src/services/matrixThreadRoute.js': '643755f436fdafcf67dcfb47540385e83dc5ea9d9bc1b92d03d580de0f824d04',
  'src/services/matrixThreadPreview.js': '6b7889bb0a1a3a90f18133d6f08e33fd98f0b0178405984204f4a02cae926b1c',
  'src/services/matrixThreadDelivery.js': 'f2ad76f999d76382093503b5a549f9cf554290419ffe5441ff1464097b0a5319',
  'src/services/matrixLedgerCommand.js': '1438b56e9f3e5389a86aa2297332aab93bdf80ec7570a853dd21302dc4a06a9d',
  'src/services/matrixLedgerCutover.js': '3a30ec2fac78dc9d5442ef8c1517cc8d205358f00f5cc6b03623a0801cf2dca1',
  'src/services/matrixLedgerStore.js': '708ab6f9e53bc0e0cebacc7c1319dc50c5e52fe76b2addc870d272e1a1b499ff',
  'src/services/matrixIntakeBridge.js': 'a122d411a2a26d5607daf87e5b7793bdf308bf10b0639320a11c04f5d6e09d30',
  'src/services/matrixIntakeCandidate.js': 'd79beaf45919891dc8f6745158c20950a3f3a5d05159fa75c614cb4e053dd82a',
  'src/services/matrixRouteProfiles.js': 'cab43e72e9f8cae1236103b15e65f49cee5e9692a44ea67b67c18871f071d75b',
  'src/services/matrixSignalMatch.js': 'bf20dffbcbc88cc3a7f1c049fc202d0a20d3568cda7ef0eaf520a8260164b3f8',
  'src/services/matrixStreamOntology.js': '68e673a6dcc0f79c22fabb6ad095370b5f4e44bd9df7935e27e2bdf5327bc119',
  'scripts/run-matrix-ledger-command.js': '5791ada9a5f1f146e016f583d1938a750712806051f9004f15c1e4e8a36986d2',
...
const APPROVED_CAPABILITY_SHA256 = {
  client: '0004d7bd67a66c9c5d6aa73153cdc0c764125560964ff724ff755e2e14e27bdf',
  ...
  delivery: '02f96bdc6656ca35f1d5d18e35986b6387d94caf7625dcf57f10e5a2f4d6d94e'
};
